# Service Growth Model - agent-runtime-go
...
| Field | Decision |
|---|---|
| Service type | Go-native agent runtime support |
| Primary reader or buyer | Backend teams needing deterministic Go agent execution. |
| Wedge | Integration review and adapter implementation plan. |
