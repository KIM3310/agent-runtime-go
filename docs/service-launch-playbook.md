# Service Launch Playbook - agent-runtime-go
...
- **First commercial action:** Paid readiness review, scoped proof-of-value pilot, then implementation or governance support.
