...
This document prepares payment operations for `KIM3310/agent-runtime-go` without creating a live checkout. It is not legal, tax, accounting, or financial advice.
