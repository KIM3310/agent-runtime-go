# Revenue Architecture - agent-runtime-go
...
| Repo-specific launch path | open-source Go package, Cloudflare Pages docs, Workers trace ingest, D1/KV run index, R2 trace archive |
