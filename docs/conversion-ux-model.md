# Conversion UX Model - agent-runtime-go
...
| First action | Run the smallest command or fixture that proves go test ./... passes, then inspect the generated output or failure trace. |
...
- Use Tool-call success as the buyer-facing proof metric.
