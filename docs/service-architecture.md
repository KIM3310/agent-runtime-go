# Service Architecture - agent-runtime-go
...
- **Lane:** Go-native agent runtime support
- **Primary buyer:** Backend teams needing deterministic Go agent execution
- **First motion:** Integration review and adapter implementation plan

## Recommended Architecture

Library-first repo with docs on GitHub Pages, release artifacts through GitHub Releases, optional demo API on Fly.io or Render.
...
- small container runtime for demo API
- Sentry for demo errors

## Information Needed From Account Owner

- release token if automated
- provider API key only for private demos
...
- library examples must run without secrets
